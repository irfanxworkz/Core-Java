...
public class Cake 
{
	...
	public boolean equals(Object obj) {
		...
		if(obj !=null)
		{
			...
			if(obj instanceof Cake)
			{
				...
				if(cack1.flower.equals(cack2.flower) 
						&& cack1.weight==cack2.weight
						&& cack1.shape.equals(cack2.shape)
	...
	public String toString() {
		...
		return "[Cake Flower is: "+flower+"] [cake price is: "+price+"] [cake weight is: "+weight+"] [cake shape is: "+shape+"]";
	}
}
