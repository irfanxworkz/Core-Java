...
public class Alcohol 
{
	...
	public String toString()
	{
		...
		return "[Brand: " +brand + "][Percentage:" +percentage + "][Height: " +height + "][Type:"
				+ type+"]";
	}
	...
	public boolean equals(Object obj)
	{
		...
		if (obj != null)
		{
			...
			if (obj instanceof Alcohol) {
				...
				if (alcohol1.brand.equals(alcohol2.brand)
						&& alcohol1.percentage == (alcohol2.percentage)
						&& alcohol1.height==alcohol2.height 
						&& alcohol1.type.equals(alcohol2.type)
						)
				{
