...
public class Park {
	...
	public boolean equals(Object obj) {
		...
		if (obj != null) {
			...
			if (obj instanceof Park) {
				...
				if (park1.parkName.equals(park2.parkName) && park1.location.equals(park2.location)
						&& park1.parkSize == park2.parkSize && park1.openTiming == park2.openTiming
						&& park1.clean == park2.clean && park1.playGround == park2.playGround) {
	...
	public String toString() {
		...
		return "[Park name is: " + parkName + "] [park location is: " + location + "] [parksize is: " + parkSize
				+ "] [park Opening time is: " + openTiming + "] [park is clean : " + clean + "] [park has playgpund :"
				+ playGround + "]";
	}
}
