...
public class ApplicationDTO implements Serializable {
	...
	public String toString() {
		return "ApplicationDTO: [name=" + name + ", developedBy=" + developedBy + ", version=" + version + ", size="
				+ size + ", price=" + price + ", minProcessorSpeed=" + minProcessorSpeed + ", minRamSpaceRequired="
				+ minRamSpaceRequired + ", ageLimit=" + ageLimit + ", rating=" + rating + ", createdDate=" + createdDate
				+ ", type=" + type + ", firstVersionReleaseDate=" + firstVersionReleaseDate
				+ ", currentVersionReleaseDate=" + currentVersionReleaseDate + ", nextVersionReleaseDate="
				+ nextVersionReleaseDate + ", trialDays=" + trialDays + ", langUsed=" + langUsed + ", internetNeeded="
				+ internetNeeded + ", noOfDownloads=" + noOfDownloads + ", osTypeSupportsd=" + osTypeSupportsd + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		return Double.doubleToLongBits(ageLimit) == Double.doubleToLongBits(other.ageLimit)
				...
				&& Objects.equals(trialDays, other.trialDays) && type == other.type
